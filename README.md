...
- **[Gesture recognition using dsPIC](https://www.microchip.com/en-us/tools-resources/reference-designs/machine-learning-with-ai-based-gesture-recognition-demonstration-application)** – gesture recognition on dsPIC device
